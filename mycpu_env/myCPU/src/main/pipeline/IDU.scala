...
class ID_Stage extends Module {
    ...
    val decode = ListLookup(inst, 
        ...
        Array (
            ...
            ld_b      -> List(ALU_LD,     BR_X,    SRC1_REG, SRC2_si12, MEM_RB, MEM_WX, RF_S, WB_MEM, RS_J, RS_X),
            ld_h      -> List(ALU_LD,     BR_X,    SRC1_REG, SRC2_si12, MEM_RH, MEM_WX, RF_S, WB_MEM, RS_J, RS_X),
            ld_w      -> List(ALU_LD,     BR_X,    SRC1_REG, SRC2_si12, MEM_RS, MEM_WX, RF_S, WB_MEM, RS_J, RS_X),
            ld_bu     -> List(ALU_LD,     BR_X,    SRC1_REG, SRC2_si12, MEM_RBU,MEM_WX, RF_S, WB_MEM, RS_J, RS_X),
            ld_hu     -> List(ALU_LD,     BR_X,    SRC1_REG, SRC2_si12, MEM_RHU,MEM_WX, RF_S, WB_MEM, RS_J, RS_X),
            st_b      -> List(ALU_ST,     BR_X,    SRC1_REG, SRC2_si12, MEM_RS, MEM_WB, RF_X, WB_X,   RS_J, RS_D),
            st_h      -> List(ALU_ST,     BR_X,    SRC1_REG, SRC2_si12, MEM_RS, MEM_WH, RF_X, WB_X,   RS_J, RS_D),
            ...
            blt       -> List(ALU_X,      BR_BLT,  SRC1_PC,  SRC2_si16, MEM_RX, MEM_WX, RF_X, WB_X,   RS_J, RS_D),
            bltu      -> List(ALU_X,      BR_BLTU, SRC1_PC,  SRC2_si16, MEM_RX, MEM_WX, RF_X, WB_X,   RS_J, RS_D),
            bge       -> List(ALU_X,      BR_BGE,  SRC1_PC,  SRC2_si16, MEM_RX, MEM_WX, RF_X, WB_X,   RS_J, RS_D),
            bgeu      -> List(ALU_X,      BR_BGEU, SRC1_PC,  SRC2_si16, MEM_RX, MEM_WX, RF_X, WB_X,   RS_J, RS_D),
